...
//Logs the last car without the lastCar variable 
...
//created carYears2 because I had been pushing to carYears and so was getting extra values in the array when I tried to log it. 
let carYears2 = [];

for (i = 0; i < inventory.length; i++) {
    carYears2.push(inventory[i]["car_year"])
}
